package com.example.bookregistrationfirebaseapp;
...
import com.example.bookregistrationfirebaseapp.Books;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookISBN=(EditText)findViewById(R.id.ISBNnumber);
        bookName=(EditText)findViewById(R.id.book);
        bookAuthor=(EditText)findViewById(R.id.author);
        bookPublisher=(EditText)findViewById(R.id.publication);
